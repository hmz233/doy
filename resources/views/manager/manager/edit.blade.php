...
@section('body')
    <blockquote class="layui-elem-quote">编辑管理</blockquote>
    ...
    <form class="layui-form layui-form-pane" action="" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="name" value="{{old('name') ? old('name') : $info->data->name}}"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="username" value="{{old('username') ? old('username') : $info->data->username}}" lay-verify="required"
                       placeholder="请输入" autocomplete="off" class="layui-input">
            ...
            <div class="layui-input-inline">
                <select name="group_id">
                    ...
                    @foreach($groupList as $key=>$vo)
                        <option value="{{$vo->id}}" @if($info->data->group_id == $vo->id) selected @endif>{{$vo->name}}</option>
                    @endforeach
                </select>
