...
@section('body')
    <blockquote class="layui-elem-quote">新增角色组</blockquote>
    ...
    <form class="layui-form layui-form-pane" action="" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="name" value="{{old('name')}}" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item layui-form-text" style="width: 300px;">
            ...
            <div class="layui-input-block">
                <textarea name="spk" placeholder="请输入描述内容" class="layui-textarea"></textarea>
            </div>
        </div>
